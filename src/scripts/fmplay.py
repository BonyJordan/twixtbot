...
parser = argparse.ArgumentParser(description="self-play robots for first play")
...
def mkcmd():
    ps = "nnmplayer:resource=a,trials=1500,smart_root=1"
	...
	"-w", ps, "-b", ps, "-M", "-F", "--first_moves_model", "2", "-T",
        subdir + "/%n%"]
